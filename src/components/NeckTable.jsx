...
export class NeckTable extends React.Component {
  ...
  render () {
    ...
    return <div className="neck-table">
        ...
        <GuitarNeck special_notes={this.props.special_notes} notes_displayed={this.state.notes_displayed} selected_note_index={this.props.selected_note_index} selected_scale={this.props.selected_scale} tuning={this.state.selected_tuning} selected_scale_notes={selected_scale_notes}/>
      </div>
  }
}
